...
const Hero = () => {
  return (
    <div className="relative w-full h-[1028px] md:h-[1065px]">
      {/* Heading */}
      <h1 className="absolute left-1/2 top-[167px] -translate-x-1/2 w-[296px] h-[114px] md:w-[672px] md:h-[96px] text-center text-[38px] md:text-[48px] font-bold leading-[100%] text-black font-sora z-[1]">
      ...
      {/* CTA Button */}
      <Button className="absolute top-[924px] md:top-[368px] left-1/2 -translate-x-1/2 w-[167px] md:w-[213.73px] h-[54px] rounded-[28px] uppercase font-sora font-bold md:font-normal text-black bg-[rgba(18,237,57,1)] hover:bg-[rgba(18,237,57,0.9)]">
